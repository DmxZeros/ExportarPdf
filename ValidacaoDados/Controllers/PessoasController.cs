...
namespace ValidacaoDados.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PessoaID,Nome,Idade,Nascimento,Email,ConfirmaEmail")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PessoaID,Nome,Idade,Nascimento,Email,ConfirmaEmail")] Pessoa pessoa)
        {
        ...
        public IActionResult VisualizarCSV()
        {
            ...
            arquivo.AppendLine("PessoaID;Nome;Idade;Nascimento;Email");

            foreach(var item in registros)
            {
                arquivo.AppendLine(item.PessoaID + ";" + item.Nome + ";" + item.Idade + ";" + item.Nascimento + ";" + item.Email); 
            }

            return File(Encoding.ASCII.GetBytes(arquivo.ToString()), "text/csv", "dados.csv");
        }

        public IActionResult VisualizaePDF()
        {
